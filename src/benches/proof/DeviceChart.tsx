...
import { barPath, niceTicks, timeScale, truncate, type TimeScale } from "../../lib/chart";
import { formatCount, plural } from "../../lib/format";
import { clamp } from "../../lib/math";
import type { BenchResult } from "./api";
import { summariseDevices, type DeviceRow } from "./devices";
...
export function DeviceChart({ rows, selfUa }: { rows: readonly BenchResult[]; selfUa: string }) {
                ...
                {hover && (
                    ...
                    <div className="tooltip" aria-hidden="true"
                        ...
                        <span className="tooltip-meta">
                            {hover.device.cores || "?"} cores · median of {plural(hover.runs, "run")}
                        </span>
                    </div>
                )}
            </div>
